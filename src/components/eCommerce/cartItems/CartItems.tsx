...
type CartItemsProps = TProduct & {changeQuantityHandler: (id:number, quantity:number) => void};


const CartItems = memo(({title, img, price, max, quantity , changeQuantityHandler, id}: CartItemsProps) => {
    console.log("render")
        ...
        <div className="product flex justify-between items-center my-5">
            <div className="flex items-center ">
                ...
                <div className="ml-7">
                    ...
                    <div className="mt-8">
                        <button className="bg-neutral-500 rounded-lg px-3 text-white py-1">Remove</button>
                    </div>
                </div>
            </div>
